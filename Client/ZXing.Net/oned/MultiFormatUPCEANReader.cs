...
namespace ZXing.OneD
{
    ...
    public sealed class MultiFormatUPCEANReader : OneDReader
    {
                                         ...
                                         IDictionary<DecodeHintType, object> hints)
        {
            ...
            {
                var result = reader.decodeRow(rowNumber, row, startGuardPattern, hints);
                if (result == null)
                    continue;
                ...
                var ean13MayBeUPCA =
                    ...
                    result.Text[0] == '0';
                var possibleFormats =
                    hints == null || !hints.ContainsKey(DecodeHintType.POSSIBLE_FORMATS)
                        ? null
                        : (IList<BarcodeFormat>)hints[DecodeHintType.POSSIBLE_FORMATS];
                var canReturnUPCA = possibleFormats == null || possibleFormats.Contains(BarcodeFormat.UPC_A) ||
                                    possibleFormats.Contains(BarcodeFormat.All_1D);
