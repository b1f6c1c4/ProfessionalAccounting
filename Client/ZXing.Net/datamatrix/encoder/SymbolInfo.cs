...
namespace ZXing.Datamatrix.Encoder
{
    ...
    public class SymbolInfo
    {
       ...
       */
        public static void overrideSymbolSet(SymbolInfo[] @override) { symbols = @override; }
                                        ...
                                        bool fail)
        {
            ...
            {
                if (shape == SymbolShapeHint.FORCE_SQUARE &&
                    symbol.rectangular)
                    continue;
        ...
        public int getSymbolDataWidth() { return getHorizontalDataRegions() * matrixWidth; }

        public int getSymbolDataHeight() { return getVerticalDataRegions() * matrixHeight; }

        public int getSymbolWidth() { return getSymbolDataWidth() + (getHorizontalDataRegions() * 2); }

        public int getSymbolHeight() { return getSymbolDataHeight() + (getVerticalDataRegions() * 2); }

        public int getCodewordCount() { return dataCapacity + errorCodewords; }

        public virtual int getInterleavedBlockCount() { return dataCapacity / rsBlockData; }

        public virtual int getDataLengthForInterleavedBlock(int index) { return rsBlockData; }

        public int getErrorLengthForInterleavedBlock(int index) { return rsBlockError; }
