...
namespace ZXing.Datamatrix.Internal
{
    ...
    public sealed class Version
    {
                         ...
                         ECBlocks ecBlocks)
        {
            ...
            var total = 0;
            var ecCodewords = ecBlocks.ECCodewords;
            var ecbArray = ecBlocks.ECBlocksValue;
        ...
        public int getSymbolSizeRows() { return symbolSizeRows; }

        public int getSymbolSizeColumns() { return symbolSizeColumns; }

        public int getDataRegionSizeRows() { return dataRegionSizeRows; }

        public int getDataRegionSizeColumns() { return dataRegionSizeColumns; }

        public int getTotalCodewords() { return totalCodewords; }

        internal ECBlocks getECBlocks() { return ecBlocks; }
        ...
        internal sealed class ECBlocks
        {
            ...
            internal int ECCodewords { get { return ecCodewords; } }

            internal ECB[] ECBlocksValue { get { return _ecBlocksValue; } }
        }
        ...
        internal sealed class ECB
        {
            ...
            internal int DataCodewords { get { return dataCodewords; } }
        }

        public override String ToString() { return versionNumber.ToString(); }
