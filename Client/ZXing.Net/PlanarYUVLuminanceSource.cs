...
namespace ZXing
{
    ...
    public sealed class PlanarYUVLuminanceSource : BaseLuminanceSource
    {
        ...
        {
            var width = Width / THUMBNAIL_SCALE_FACTOR;
            var height = Height / THUMBNAIL_SCALE_FACTOR;
            ...
            for (var y = 0; y < height; y++)
            {
                ...
                {
                    var grey = yuv[inputOffset + x * THUMBNAIL_SCALE_FACTOR] & 0xff;
        ...
        /// </summary>
        public int ThumbnailWidth { get { return Width / THUMBNAIL_SCALE_FACTOR; } }

        /// <summary>
        ///     height of image from {@link #renderThumbnail()}
        /// </summary>
        public int ThumbnailHeight { get { return Height / THUMBNAIL_SCALE_FACTOR; } }
