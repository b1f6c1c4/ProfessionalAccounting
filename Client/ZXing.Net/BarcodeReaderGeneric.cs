...
namespace ZXing
{
    ...
    public class BarcodeReaderGeneric<T> : IBarcodeReaderGeneric<T>, IMultipleBarcodeReaderGeneric<T>
    {
        ...
        protected static readonly Func<byte[], int, int, RGBLuminanceSource.BitmapFormat, LuminanceSource>
            defaultCreateRGBLuminanceSource =
                (rawBytes, width, height, format) => new RGBLuminanceSource(rawBytes, width, height, format);

        private Reader reader;

        private readonly Func<byte[], int, int, RGBLuminanceSource.BitmapFormat, LuminanceSource>
      ...
      private readonly Func<T, int, int, LuminanceSource> createLuminanceSource;
        ...
        ///     The reader.
        /// </value>
        protected Reader Reader { get { return reader ?? (reader = new MultiFormatReader()); } }
        ...
        public bool TryHarder { get { return Options.TryHarder; } set { Options.TryHarder = value; } }
        ...
        public bool PureBarcode { get { return Options.PureBarcode; } set { Options.PureBarcode = value; } }
        ...
        public string CharacterSet { get { return Options.CharacterSet; } set { Options.CharacterSet = value; } }
    ...
    /// </value>
      protected Func<T, int, int, LuminanceSource> CreateLuminanceSource
#endif
        {
            get { return createLuminanceSource; }
        }
        ...
        ///     If null then HybridBinarizer is used
        /// </param>
        /// <param name="createRGBLuminanceSource">
...
#endif
                                    Func<LuminanceSource, Binarizer> createBinarizer,
                                    Func<byte[], int, int, RGBLuminanceSource.BitmapFormat, LuminanceSource>
                                        createRGBLuminanceSource
            )
        {
