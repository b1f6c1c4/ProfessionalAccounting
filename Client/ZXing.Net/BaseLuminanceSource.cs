...
namespace ZXing
{
    ...
    public abstract class BaseLuminanceSource : LuminanceSource
    {
        ...
        protected BaseLuminanceSource(int width, int height)
            : base(width, height) { luminances = new byte[width * height]; }
        ...
        public override byte[] Matrix { get { return luminances; } }
        ...
        public override bool RotateSupported { get { return true; } }
        ...
        public override bool CropSupported { get { return true; } }

        /// <summary>
        /// </summary>
        /// <returns>Whether this subclass supports invertion.</returns>
        public override bool InversionSupported { get { return true; } }

        /// <summary>
        ///     Inverts the luminance values (newValue = 255 - oldValue)
        /// </summary>
        public override LuminanceSource invert() { return new InvertedLuminanceSource(this); }
