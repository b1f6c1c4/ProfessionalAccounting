...
namespace ZXing.Common.ReedSolomon
{
    ...
    public sealed class GenericGF
    {
        ...
        internal GenericGFPoly Zero { get { return zero; } }

        internal GenericGFPoly One { get { return one; } }
        ...
        internal static int addOrSubtract(int a, int b) { return a ^ b; }
        ...
        /// </summary>
        public int GeneratorBase { get { return generatorBase; } }
        ...
        /// </returns>
        public override String ToString() { return "GF(0x" + primitive.ToString("X") + ',' + size + ')'; }
    }
}
