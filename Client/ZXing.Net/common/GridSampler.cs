...
namespace ZXing.Common
{
    ...
    public abstract class GridSampler
    {
        ...
        /// </returns>
        public static GridSampler Instance { get { return gridSampler; } }

        private static GridSampler gridSampler = new DefaultGridSampler();

        /// <summary>
        ///     Sets the implementation of <see cref="GridSampler" /> used by the library. One global
        ...
        public abstract BitMatrix sampleGrid(BitMatrix image, int dimensionX, int dimensionY, float p1ToX, float p1ToY,
                                             float p2ToX, float p2ToY, float p3ToX, float p3ToY, float p4ToX,
                                             float p4ToY, float p1FromX, float p1FromY, float p2FromX, float p2FromY,
                                             float p3FromX, float p3FromY, float p4FromX, float p4FromY);
