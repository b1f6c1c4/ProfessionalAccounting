...
namespace ZXing.Common.Detector
{
    ...
    public sealed class MonochromeRectangleDetector
    {
        ...
        public ResultPoint[] detect()
        {
            ...
            var deltaY = Math.Max(1, height / (MAX_MODULES << 3));
            var deltaX = Math.Max(1, width / (MAX_MODULES << 3));

            var top = 0;
            var bottom = height;
            var left = 0;
            var right = width;
            var pointA = findCornerFromCenter(
                                              halfWidth,
                                              0,
                                              left,
                                              right,
            ...
            if (pointA == null)
                return null;
            top = (int)pointA.Y - 1;
            var pointB = findCornerFromCenter(
                                              halfWidth,
                                              -deltaX,
                                              left,
                                              right,
            ...
            if (pointB == null)
                return null;
            left = (int)pointB.X - 1;
            var pointC = findCornerFromCenter(
                                              halfWidth,
                                              deltaX,
                                              left,
                                              right,
            ...
            var pointD = findCornerFromCenter(
                                              halfWidth,
                                              0,
                                              left,
                                              right,
                ...
                else
                {
                    ...
                    do
                    {
                        start--;
                             ...
                             !(horizontal ? image[start, fixedDimension] : image[fixedDimension, start]));
                    var whiteRunSize = whiteRunStart - start;
                    if (start < minDim ||
                        whiteRunSize > maxWhiteRun)
                    {
                        start = whiteRunStart;
                        break;
                    }
            ...
            while (end < maxDim)
                ...
                else
                {
                    ...
                    do
                    {
                             ...
                             !(horizontal ? image[end, fixedDimension] : image[fixedDimension, end]));
