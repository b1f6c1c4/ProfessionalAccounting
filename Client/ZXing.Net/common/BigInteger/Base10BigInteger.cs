...
namespace BigIntegerLibrary
{
    ...
    internal sealed class Base10BigInteger
    {
        ...
        /// </summary>
        internal Sign NumberSign { set { sign = value; } }
        ...
        /// <returns>
        ///     True if the specified Base10BigInteger is equal to the current Base10BigInteger,
        ///     false otherwise
        /// </returns>
        ...
        /// <returns>
        ///     True if the specified System.Object is equal to the current Base10BigInteger,
        ///     false otherwise
        /// </returns>
        ...
        {
            var res = new Base10BigInteger(n);
        ...
        {
            var res = new Base10BigInteger(a);
            long trans = 0, temp;
            int i;
