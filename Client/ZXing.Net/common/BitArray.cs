...
namespace ZXing.Common
{
    ...
    public sealed class BitArray
    {
        ...
        public int SizeInBytes { get { return (size + 7) >> 3; } }
        ...
        ///     bit to set
        /// </param>
        public void flip(int i) { bits[i >> 5] ^= 1 << (i & 0x1F); }
        ...
        /// <returns>
        ///     index of first bit that is set, starting from the given index, or size if none are set
        ...
        /// </param>
        public void setBulk(int i, int newBits) { bits[i >> 5] = newBits; }
        ...
        /// </returns>
        public int[] Array { get { return bits; } }
        ...
        private static int[] makeArray(int size) { return new int[(size + 31) >> 5]; }
        ...
        /// </returns>
        public object Clone() { return new BitArray((int[])bits.Clone(), size); }
    }
}
