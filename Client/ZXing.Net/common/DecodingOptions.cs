...
namespace ZXing.Common
{
    ...
    public class DecodingOptions
    {
        ...
        private class ChangeNotifyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
        {
            ...
            public ChangeNotifyDictionary() { values = new Dictionary<TKey, TValue>(); }
            ...
            public bool ContainsKey(TKey key) { return values.ContainsKey(key); }

            public ICollection<TKey> Keys { get { return values.Keys; } }
            ...
            public bool TryGetValue(TKey key, out TValue value) { return values.TryGetValue(key, out value); }

            public ICollection<TValue> Values { get { return values.Values; } }
            ...
            public bool Contains(KeyValuePair<TKey, TValue> item) { return values.Contains(item); }

            public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex) { values.CopyTo(array, arrayIndex); }
            ...
            public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() { return values.GetEnumerator(); }
