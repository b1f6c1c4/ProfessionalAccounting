...
namespace ZXing.QrCode.Internal
{
    ...
    public sealed class ByteMatrix
    {
        ...
        /// </summary>
        public int this[int x, int y] { get { return bytes[y][x]; } set { bytes[y][x] = (byte)value; } }

        /// <summary>
        ///     an internal representation as bytes, in row-major order. array[y][x] represents point (x,y)
        /// </summary>
        public byte[][] Array { get { return bytes; } }
        ...
        public void set(int x, int y, byte value) { bytes[y][x] = value; }
        ...
        public void set(int x, int y, bool value) { bytes[y][x] = (byte)(value ? 1 : 0); }
