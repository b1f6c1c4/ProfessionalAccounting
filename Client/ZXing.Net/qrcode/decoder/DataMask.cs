...
namespace ZXing.QrCode.Internal
{
    ...
    internal abstract class DataMask
    {
        ...
        {
            internal override bool isMasked(int i, int j) { return ((((i + j) & 0x01) + ((i * j) % 3)) & 0x01) == 0; }
        }
    }
}
