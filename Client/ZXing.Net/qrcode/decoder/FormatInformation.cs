...
namespace ZXing.QrCode.Internal
{
    ...
    internal sealed class FormatInformation
    {
        ...
        private static FormatInformation doDecodeFormatInformation(int maskedFormatInfo1, int maskedFormatInfo2)
        {
            ...
            var bestDifference = Int32.MaxValue;
        ...
        internal ErrorCorrectionLevel ErrorCorrectionLevel { get { return errorCorrectionLevel; } }

        internal byte DataMask { get { return dataMask; } }

        public override int GetHashCode() { return (errorCorrectionLevel.ordinal() << 3) | dataMask; }
