    ...
    public class DetectionResult
    {
        ...
        private void adjustRowNumbersFromBothRI()
        {
            if (DetectionResultColumns[0] == null ||
                DetectionResultColumns[ColumnCount + 1] == null)
                return;
            var LRIcodewords = DetectionResultColumns[0].Codewords;
            var RRIcodewords = DetectionResultColumns[ColumnCount + 1].Codewords;
        ...
        private int adjustRowNumbersFromRRI()
        {
            ...
            var codewords = DetectionResultColumns[ColumnCount + 1].Codewords;
            for (var codewordsRow = 0; codewordsRow < codewords.Length; codewordsRow++)
            {
                if (codewords[codewordsRow] == null)
                    continue;
                ...
                for (var barcodeColumn = ColumnCount + 1;
        ...
        private int adjustRowNumbersFromLRI()
        {
            if (DetectionResultColumns[0] == null)
                return 0;
            var unadjustedCount = 0;
            var codewords = DetectionResultColumns[0].Codewords;
            for (var codewordsRow = 0; codewordsRow < codewords.Length; codewordsRow++)
            {
                if (codewords[codewordsRow] == null)
                    continue;
                var rowIndicatorRowNumber = codewords[codewordsRow].RowNumber;
                var invalidRowCounts = 0;
                for (var barcodeColumn = 1;
                     barcodeColumn < ColumnCount + 1 && invalidRowCounts < ADJUST_ROW_NUMBER_SKIP;
                     barcodeColumn++)
                {
                    var codeword = DetectionResultColumns[barcodeColumn].Codewords[codewordsRow];
                    if (codeword != null)
        ...
        private void adjustRowNumbers(int barcodeColumn, int codewordsRow, Codeword[] codewords)
        {
            ...
            var previousColumnCodewords = DetectionResultColumns[barcodeColumn - 1].Codewords;
            ...
            var otherCodewords = new Codeword[14];
            ...
            foreach (var otherCodeword in otherCodewords)
        ...
        ///     <see cref="ZXing.PDF417.Internal.DetectionResult" />.
        /// </summary>
        /// <returns>
        ...
        public override string ToString()
        {
            ...
            var rowIndicatorColumn = DetectionResultColumns[0];
            ...
            for (var codewordsRow = 0; codewordsRow < rowIndicatorColumn.Codewords.Length; codewordsRow++)
            {
                ...
                for (var barcodeColumn = 0; barcodeColumn < ColumnCount + 2; barcodeColumn++)
                {
