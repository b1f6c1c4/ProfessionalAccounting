...
namespace ZXing.PDF417.Internal.EC
{
    ...
    internal sealed class ModulusPoly
    {
        ...
        {
            var size = coefficients.Length;
            var negativeCoefficients = new int[size];
        ...
        ///     <see cref="ZXing.PDF417.Internal.EC.ModulusPoly" />.
        /// </summary>
        /// <returns>
        ///     A <see cref="System.String" /> that represents the current <see cref="ZXing.PDF417.Internal.EC.ModulusPoly" />
        ///     .
        /// </returns>
