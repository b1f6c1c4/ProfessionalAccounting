...
namespace ZXing.PDF417.Internal
{
    ...
    internal sealed class PDF417
    {
        ...
        internal BarcodeMatrix BarcodeMatrix { get { return barcodeMatrix; } }
        ...
        internal void generateBarcodeLogic(String msg, int errorCorrectionLevel)
        {
            ...
            var highLevel = PDF417HighLevelEncoder.encodeHighLevel(msg, compaction, encoding, disableEci);
            var sourceCodeWords = highLevel.Length;

            var dimension = determineDimensions(sourceCodeWords, errorCorrectionCodeWords);
            ...
            var fullCodewords = dataCodewords + ec;
        ...
        private int[] determineDimensions(int sourceCodeWords, int errorCorrectionCodeWords)
        {
            ...
            {
                var rows = calculateNumberOfRows(sourceCodeWords, errorCorrectionCodeWords, cols);
                ...
                var newRatio = ((17 * cols + 69) * DEFAULT_MODULE_WIDTH) / (rows * HEIGHT);
            ...
            if (dimension == null)
            {
                var rows = calculateNumberOfRows(sourceCodeWords, errorCorrectionCodeWords, minCols);
                if (rows < minRows)
        ...
        internal void setDisableEci(bool disabled) { disableEci = disabled; }
    }
}
