...
namespace ZXing.Mobile
{
    public class MobileBarcodeScanner : MobileBarcodeScannerBase
    {
        ...
        private readonly UIViewController appController;
        private readonly ManualResetEvent scanResultResetEvent = new ManualResetEvent(false);

        public MobileBarcodeScanner(UIViewController delegateController) { appController = delegateController; }
        ...
        public override Task<Result> Scan(MobileBarcodeScanningOptions options) { return Scan(options, false); }
                                         ...
                                         () =>
                                         {
                                             try
                                             {
                                                 ...
                                                 if (useAVCaptureEngine)
                                                     allRequestedFormatsSupported =
                                                         AVCaptureScannerView.SupportsAllRequestedBarcodeFormats(
                                                                                                                 options
                                                                                                                     .PossibleFormats);
                                                 ...
                                                 appController.InvokeOnMainThread(
                                                                                  () =>
                                                                                  {
                                                                                      if (useAVCaptureEngine &&
                                                                                          ...
                                                                                          allRequestedFormatsSupported)
                                                                                          viewController =
                                                                                              new AVCaptureScannerViewController
                                                                                                  (options, this);
                                                                                      else
                                                                                      {
                                                                                          if (useAVCaptureEngine &&
                                                                                          ...
                                                                                          else if (useAVCaptureEngine &&
                                                                                                   !allRequestedFormatsSupported)
                                                                                              Console.WriteLine(
                                                                                                                "Not all requested barcode formats were supported by AVCapture, using ZXing instead");

                                                                                          viewController =
                                                                                              new ZXingScannerViewController
                                                                                                  (options, this);
                                                                                      }

                                                                                      viewController.OnScannedResult +=
                                                                                          barcodeResult =>
                                                                                          {
                                                                                              ((UIViewController)
                                                                                               viewController)
        ...
        public override void ToggleTorch() { viewController.ToggleTorch(); }
        ...
        public override bool IsTorchOn { get { return viewController.IsTorchOn; } }
