...
namespace ZXing.Mobile
{
    public class ZXingDefaultOverlayView : UIView
    {
        ...
        {
            this.cancelText = cancelText ?? "È¡Ïû";
            this.flashText = flashText ?? "µÆ";
        ...
        private readonly string flashText;
        private readonly string topText;
        private readonly string bottomText;

        private readonly Action OnCancel;
        private readonly Action OnTorch;
        ...
        private void Initialize()
        {
            ...
            //bottomBg =
            //    new UIView(new CGRect(0, topBg.Frame.Height + picFrame.Height, overlaySize.Width, topBg.Frame.Height));
            ...
            //redLine.Alpha = 0.4f;
            //redLine.AutoresizingMask = UIViewAutoresizing.FlexibleWidth | UIViewAutoresizing.FlexibleBottomMargin |
        ...
        //    //    topBg.Frame = new CGRect(0, 0, overlaySize.Width, overlaySize.Height * 0.30f);
        //    //if (bottomBg != null)
        //    //    bottomBg.Frame = new CGRect(
        //    //        0,
        //    //        overlaySize.Height * 0.70f,
        //    //        overlaySize.Width,
        //    //        overlaySize.Height * 0.30f);

        //    //if (textTop != null)
        //    //    textTop.Frame = topBg.Frame; //  new RectangleF(0, overlaySize.Height *  0.10f, overlaySize.Width, 42);
        //    //if (textBottom != null)
        //    //    textBottom.Frame = bottomBg.Frame;
        //    //        // new RectangleF(0, overlaySize.Height *  0.825f - 32f, overlaySize.Width, 64);
