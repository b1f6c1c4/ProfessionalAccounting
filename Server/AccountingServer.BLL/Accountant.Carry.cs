    ...
    partial class Accountant
    {
        ...
        public void Carry(DateTime? dt)
        {
            ...
            if (dt.HasValue)
            {
                ...
                ed = LastDayOfMonth(dt.Value.Year, dt.Value.Month);
        ...
        public void CarryYear(DateTime? dt, bool includeNull = false)
        {
            ...
            var r00 = SelectVoucherDetailsGrouped(
                                                  new GroupedQueryBase(
                                                      filter: new VoucherDetail { Title = 4103, SubTitle = 00 },
                                                      rng: rng)).SingleOrDefault();
            var b00 = r00 == null ? 0 : r00.Fund;

            var r01 = SelectVoucherDetailsGrouped(
                                                  new GroupedQueryBase(
                                                      filter: new VoucherDetail { Title = 4103, SubTitle = 01 },
                                                      rng: rng)).SingleOrDefault();
            var b01 = r01 == null ? 0 : r01.Fund;
