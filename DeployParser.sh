...
cp AccountingServer.QueryGeneration/obj/Gen/net7.0/Query{.tokens,Lexer.{cs,tokens},Parser.cs} \
    AccountingServer.BLL/Parsing/
cp AccountingServer.QueryGeneration/obj/Gen/net7.0/Subtotal{.tokens,Lexer.{cs,tokens},Parser.cs} \
    AccountingServer.BLL/Parsing/
