        ...
        IQueryCompounded<IVoucherQueryAtom> query)
    {
        ...
        foreach (
            ...
            Db.SelectVouchers(ParsingF.VoucherQuery(
                    $"{asset.User.AsUser()} {asset.Title.AsTitle()} {asset.StringID.Quotation('\'')}", Client))
        ...
        foreach (
            ...
            Db.SelectVouchers(
                ParsingF.VoucherQuery(
                    $"{asset.User.AsUser()} {asset.DepreciationTitle.AsTitle()} {asset.StringID.Quotation('\'')}",
        ...
        foreach (
            ...
            Db.SelectVouchers(
                ParsingF.VoucherQuery(
                    $"{asset.User.AsUser()} {asset.DevaluationTitle.AsTitle()} {asset.StringID.Quotation('\'')}",
                    Client)).ToEnumerable() // TODO
        )
        {
            if (voucher.Remark == Asset.IgnoranceMark)
