...
public class MatchHelperTest
{
    ...
    [InlineData(false, 2999, TitleKind.Mutual)]
    [InlineData(true, 3000, TitleKind.Mutual)]
    [InlineData(true, 3999, TitleKind.Mutual)]
    [InlineData(false, 4000, TitleKind.Mutual)]
    [InlineData(false, 3500, TitleKind.Equity)]
    [InlineData(true, 4500, TitleKind.Equity)]
    [InlineData(false, 5000, TitleKind.Equity)]
    [InlineData(true, 4999, TitleKind.Static)]
    [InlineData(false, 5000, TitleKind.Static)]
    [InlineData(false, 4999, TitleKind.Dynamic)]
    [InlineData(true, 5000, TitleKind.Dynamic)]
    [InlineData(false, 4999, TitleKind.Cost)]
    [InlineData(true, 5000, TitleKind.Cost)]
    [InlineData(true, 5999, TitleKind.Cost)]
    [InlineData(false, 6000, TitleKind.Cost)]
    [InlineData(false, 5800, TitleKind.Revenue)]
    [InlineData(true, 6000, TitleKind.Revenue)]
    [InlineData(false, 6400, TitleKind.Revenue)]
    [InlineData(false, 6603, TitleKind.Revenue)]
    [InlineData(false, 6603, TitleKind.Revenue, 00)]
    [InlineData(false, 6603, TitleKind.Revenue, 01)]
    [InlineData(true, 6603, TitleKind.Revenue, 02)]
    [InlineData(false, 6603, TitleKind.Revenue, 03)]
    [InlineData(false, 6300, TitleKind.Expense)]
    [InlineData(true, 6500, TitleKind.Expense)]
    [InlineData(true, 6603, TitleKind.Expense)]
    [InlineData(true, 6603, TitleKind.Expense, 00)]
    [InlineData(true, 6603, TitleKind.Expense, 01)]
    [InlineData(false, 6603, TitleKind.Expense, 02)]
    [InlineData(true, 6603, TitleKind.Expense, 03)]
